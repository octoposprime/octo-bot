...
type EBusPort interface {
	...
	// Listen listens to the event bus and calls the given callBack function for each received octoBot.
	Listen(ctx context.Context, channelName string, callBack func(channelName string, octoBot me.OctoBot))
}
