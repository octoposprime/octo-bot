...
import (
	...
	ia_ebus "github.com/octoposprime/octo-bot/pkg/infrastructure/adapter/ebus"
	ia_repo "github.com/octoposprime/octo-bot/pkg/infrastructure/adapter/repository"
	ia_service "github.com/octoposprime/octo-bot/pkg/infrastructure/adapter/service"
	pc_grpc "github.com/octoposprime/octo-bot/pkg/presentation/controller/grpc"
	pc_probe "github.com/octoposprime/octo-bot/pkg/presentation/controller/probe"
...
func main() {
	...
	fmt.Println("Starting OctoBot Service...")
	...
	//Infrastructure OctoBot Service Adapter
	...
	//Infrastructure OctoBot Redis Repository Adapter
	...
	//Infrastructure OctoBot EBus Adapter
	...
	wg.Add(1)
	go pc_grpc.NewGrpc(queryHandler, commandHandler).Serve(internalConfig.Grpc.OctoBotPort)
	wg.Wait()
